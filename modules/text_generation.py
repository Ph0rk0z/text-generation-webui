...
def _generate_reply(question, state, stopping_strings=None, is_chat=False, escape_html=False, for_ui=False):
    ...
    if generate_func is None:
        ...
        if shared.model.__class__.__name__ in ['LlamaCppModel', 'Exllamav2Model', 'ExllamaModel', 'TensorRTLLMModel']:
...
def encode(prompt, add_special_tokens=True, add_bos_token=True, truncation_length=None):
    ...
    if shared.model.__class__.__name__ in ['LlamaCppModel', 'Exllamav2Model', 'ExllamaModel', 'TensorRTLLMModel'] or shared.args.cpu:
        return input_ids
